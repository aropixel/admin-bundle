                ...
                ->arrayNode('theme')
                    ...
                    ->children()
                        ->arrayNode('logo')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('path')->defaultValue('bundles/aropixeladmin/img/logo.png')->end()
                                ->scalarNode('width')->defaultValue('150px')->end()
                                ->arrayNode('menu')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('path')->defaultValue('bundles/aropixeladmin/img/logo-opened-menu.gif')->end()
                                        ->scalarNode('width')->defaultValue('50px')->end()
                                    ->end()
                                ->end()
                                ->arrayNode('login')
                                    ->addDefaultsIfNotSet()
                        ...
                        ->arrayNode('images')
                            ...
                            ->children()
                                ...
                                ->scalarNode('placeholder_img_path')->defaultValue('bundles/aropixeladmin/img/logo-vert.png')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
