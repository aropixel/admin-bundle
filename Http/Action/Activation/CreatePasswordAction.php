...
use Aropixel\AdminBundle\Security\PasswordCreationHandlerInterface;
...
{
    private $passwordCreationHandler;
     ...
     */
    public function __construct(PasswordCreationHandlerInterface $passwordCreationHandler, UserRepository $userRepository, ParameterBagInterface $parameterBag)
    {
