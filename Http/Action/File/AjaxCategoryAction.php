...
class AjaxCategoryAction extends AbstractController
{
     ...
     */
    public function __invoke(Request $request, Datatabler $datatabler, string $category) : Response
    {
        ...
        $datatabler = $datatabler->setRepository($fileClassName, $this->datatableFieds);
