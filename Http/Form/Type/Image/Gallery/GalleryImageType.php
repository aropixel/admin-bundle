...
namespace Aropixel\AdminBundle\Http\Form\Type\Image\Gallery;


use Aropixel\AdminBundle\Domain\Entity\Image;
use Aropixel\AdminBundle\Domain\Entity\ImageInterface;
use Aropixel\AdminBundle\Http\Form\Type\EntityHiddenType;
use Aropixel\AdminBundle\Http\Form\Type\Image\InstanceToData;
...
class GalleryImageType extends AbstractType implements DataMapperInterface
{
    ...
    /**
     * @var \Aropixel\AdminBundle\Http\Form\Type\Image\InstanceToData
     */
     ...
     * @param \Aropixel\AdminBundle\Http\Form\Type\Image\InstanceToData $instanceToData
     */
