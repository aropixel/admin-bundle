...
> Every shipped locale defines the same set of keys, so the admin is fully translated in each.
> If you add your own keys and leave a locale incomplete, configure
> `framework.translator.fallbacks` to choose what Symfony shows for the gap.
